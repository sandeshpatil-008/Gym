        ...
        <>
            <div className="hero" id='hero'>
                ...
                <div className="left-h">
                    ...
                    <div className="the-best-ad hero1">
                        <motion.div 
                    ...
                    <div className="hero-buttons">
                        ...
                        <button className='btn btnEffect'>Learn More</button>
                ...
                <div className="right-h">
                    ...
                    className="heart-rate">
                        ...
                        <span className='heart1'>Heart Rate </span><span>116 bpm</span>
                    </motion.div>
